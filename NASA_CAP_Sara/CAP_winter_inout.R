...
saveRDS(D_gower, "inside_outside/D_gower_w")
...
D_gower <- readRDS("inside_outside/D_gower_w")
...
saveRDS(cap, "inside_outside/cap_winter")
...
png("inside_outside/cap_winter_pol_inout.png", height = 30, width = 35, units = "cm", res = 300)
