...
saveRDS(D_gower, "inside/D_gower_w")
...
D_gower <- readRDS("inside/D_gower_w")
...
saveRDS(cap, "inside/cap_winter")

#------------------------------------------------------------------
# Plot CAP polynya
#------------------------------------------------------------------
cap <- readRDS("inside/cap_winter")
col = pal[as.character(meta$pol)]
select_pal = pal[c("9", "10", "11", "12", "13", "14", "16", "17", "21")]
labels = polynya_info_dict[names(select_pal)]
...
png("inside/cap_winter_pol.png", height = 30, width = 35, units = "cm", res = 300)
print(plot(cap, type = "n"))
print(text(cap, dis = "cn"))
print(points(cap, pch = 3, col = col , bg = "yellow", cex = .5))
...
png("inside/cap_winter_region.png", height = 30, width = 35, units = "cm", res = 300)
print(plot(cap, type = "n"))
print(text(cap, dis = "cn"))
